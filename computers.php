...
$sql17 = "SELECT computerid, computers.name as 'Computer Name', eventdate as 'Event Date', SUBSTRING(stat17,6) as 'Details' FROM h_extrastatsdaily JOIN computers USING (computerid) WHERE computers.computerid=:computerid AND stat17 < 1 AND stat17 != NULL AND eventdate > DATE_ADD(NOW(), INTERVAL -1 MONTH) order by eventdate desc";
